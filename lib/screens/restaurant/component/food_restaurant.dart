...
class _FoodDetail extends State<FoodDetail> {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            food!.discountId == null
                                ? Text(
                                    '${NumberFormat.currency(locale: 'vi').format(food!.price)}',
                                    style:
                                ...
                                : Row(
                                    children: [
                                      Text(
                                          '${NumberFormat.currency(locale: 'vi').format((food!.price! - food!.price! * (double.parse(food!.discount!.percent!) / 100)).round())}',
                                          style: TextStyle(
  ...
  Future<void> addCardOrder() async {
    ...
    int price = 0;
    if (food!.discountId == null) {
      price = productCounter.value * food!.price!;
    } else {
      price = productCounter.value *
          (food!.price! -
                  food!.price! * (double.parse(food!.discount!.percent!) / 100))
              .round();
    }
